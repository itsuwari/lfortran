module c_backend_assumed_shape_nested_section_explicit_01_m
implicit none
...
program c_backend_assumed_shape_nested_section_explicit_01
use c_backend_assumed_shape_nested_section_explicit_01_m, only: last_sum, outer
implicit none
