...
LFORTRAN_API void _lfortran_string_formatted_read(fchar* src_data, int64_t src_len, int32_t* iostat, int32_t* chunk, fchar* advance, int64_t advance_length, fchar* fmt, int64_t fmt_len, int32_t no_of_args, char* pad, int64_t pad_len, ...);
